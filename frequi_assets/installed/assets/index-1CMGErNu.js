import{$ as S,af as k,a0 as O,ag as w,aK as m,ao as z,X as A,a as g,c as p,f as h,a2 as y,n as V,M as s,j as I,z as B,ac as f,aQ as c,P as C,F as K,k as $,l as x,aS as D,h as E}from"./index-k4HQqNIC.js";var j=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,X={root:function(e){var n=e.props,l=e.instance;return["p-selectbutton p-component",{"p-invalid":l.$invalid,"p-selectbutton-fluid":n.fluid}]}},Y=S.extend({name:"selectbutton",style:W,classes:X}),G={name:"BaseSelectButton",extends:O,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null},fluid:{type:Boolean,default:null}},style:Y,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function J(t,e){var n=typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(!n){if(Array.isArray(t)||(n=P(t))||e){n&&(t=n);var l=0,a=function(){};return{s:a,n:function(){return l>=t.length?{done:!0}:{done:!1,value:t[l++]}},e:function(d){throw d},f:a}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
